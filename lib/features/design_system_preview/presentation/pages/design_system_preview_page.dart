...
import 'package:request_manager_app/core/theme/app_colors.dart';
import 'package:request_manager_app/core/theme/app_spacing.dart';
import 'package:request_manager_app/core/theme/app_typography.dart';
...
class _DesignSystemPreviewPageState extends State<DesignSystemPreviewPage> {
  ...
  final List<String> _publicacionesList = [
    'Libro A',
    'Revista B',
    'Libro C',
    'Manual D'
  ...
  Widget _buildTabContent() {
    if (_simulatedState == 'loading') {
      return const AppLoadingIndicator(
          message: 'Cargando datos de la sección...');
    }
            ...
            children: [
              ...
              Expanded(
                child: AppCard(
                  ...
                  child: Column(
                    children: [
                      const Icon(Icons.incomplete_circle_rounded,
  ...
  Widget _buildRecepcionesTab() {
    return SingleChildScrollView(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text('Registrar Recepción de Material',
              style: AppTypography.titleSection),
          AppSpacing.vSpacerXs,
          Text(
                      ...
                      child: AppPrimaryButton(
                        ...
                        onPressed: () {
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(
                                  'Se guardaron ${_recepcionCantidadController.text} unidades de $_selectedPublicacion en existencia.'),
  ...
  Widget _buildInventarioTab() {
    return Padding(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text('Existencia Local de Literatura',
              style: AppTypography.titleSection),
          AppSpacing.vSpacerXs,
          Text(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(
                              color:
                                  lowStock ? AppColors.error : AppColors.border,
                              width: 1.0),
                        ),
                        child: Column(
                          children: [
